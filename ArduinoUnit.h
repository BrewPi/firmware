...
// allow the concrete type to be specified. The compiler will be able to optimize some of the method calls.
// such as overrides of Print, which run very slowly in the emulator
#ifndef TEST_PRINT_TYPE
#define TEST_PRINT_TYPE Print
#else 
// value not defined - caller has to set Test::out in setup() 
#ifndef TEST_PRINT_VALUE
#define TEST_PRINT_VALUE NULL
#endif
#endif

#ifndef TEST_PRINT_VALUE
#define TEST_PRINT_VALUE &Serial
#endif

struct TEST_PRINT_TYPE;
