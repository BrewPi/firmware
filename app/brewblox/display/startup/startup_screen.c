...
const char startup_version[] = "BrewBlox " xstr(GIT_VERSION);

D4D_DECLARE_COLOR_LABEL(scrStartup_version, startup_version, 0, 140, 320, 32, FONT_SMALL, D4D_CONST, D4D_COLOR_BLACK, D4D_COLOR_BLACK);

const char startup_text[] = "Tap screen to re-calibrate touch"; // 32 characters
