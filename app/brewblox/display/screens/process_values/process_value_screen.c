...
D4D_DECLARE_PV(scrProcessValues10, SCR_PV_CX + 0 * (SCR_PV_CX + SCR_PV_CX_GAP), SCR_PV_Y0 + 1 * (SCR_PV_CY + SCR_PV_CY_GAP), SCR_PV_CX, SCR_PV_CY);
D4D_DECLARE_PV(scrProcessValues11, SCR_PV_CX + 1 * (SCR_PV_CX + SCR_PV_CX_GAP), SCR_PV_Y0 + 0 * (SCR_PV_CY + SCR_PV_CY_GAP), SCR_PV_CX, SCR_PV_CY);
D4D_DECLARE_PV(scrProcessValues12, SCR_PV_CX + 2 * (SCR_PV_CX + SCR_PV_CX_GAP), SCR_PV_Y0 + 1 * (SCR_PV_CY + SCR_PV_CY_GAP), SCR_PV_CX, SCR_PV_CY);
