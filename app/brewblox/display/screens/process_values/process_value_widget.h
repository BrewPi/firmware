...
#define D4D_DECLARE_PV(ref, x, y, cx, cy)                                                                                                                                                                                             \
    ...
    _D4D_DECLARE_LABEL(D4D_CONST, ref##_value, ref##_value_buf, 0, 0, cx, (((cy)*2) / 3), 0, nullptr, ref##_value_relations, D4D_LBL_F_DEFAULT, AS_D4D_COLOR_SCHEME(&color_scheme_pv), FONT_ARIAL7, nullptr, nullptr);                \
    _D4D_DECLARE_LABEL(D4D_CONST, ref##_setting, ref##_setting_buf, 0, (((cy)*2) / 3), cx, ((cy) / 3), 0, nullptr, ref##_setting_relations, D4D_LBL_F_DEFAULT, AS_D4D_COLOR_SCHEME(&color_scheme_pv), FONT_ARIAL7, nullptr, nullptr); \
    _D4D_DECLARE_LABEL(D4D_CONST, ref##_name, ref##_name_buf, 0, (((cy)*2) / 3), cx, ((cy) / 3), 0, nullptr, ref##_name_relations, D4D_LBL_F_DEFAULT, AS_D4D_COLOR_SCHEME(&color_scheme_pv), FONT_ARIAL7, nullptr, nullptr);          \
    D4D_DECLARE_OBJECT_RELATIONS(ref##_btn_relations, nullptr, &ref##_value, &ref##_setting, &ref##_name);                                                                                                                            \
    _D4D_DECLARE_BUTTON(D4D_CONST, ref, nullptr, x, y, cx, cy, 0, nullptr, ref##_btn_relations, (D4D_OBJECT_F_VISIBLE | D4D_OBJECT_F_ENABLED | D4D_OBJECT_F_TOUCHENABLE | D4D_OBJECT_F_FASTTOUCH), nullptr, nullptr, AS_D4D_COLOR_SCHEME(&color_scheme_pv), FONT_ARIAL7, nullptr, nullptr, nullptr);
