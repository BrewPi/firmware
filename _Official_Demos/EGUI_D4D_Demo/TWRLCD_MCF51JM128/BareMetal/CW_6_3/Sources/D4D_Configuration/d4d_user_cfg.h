...
#define D4D_LLD_LCD_HW d4dlcdhw_spi_8b   // the name of LCD hw interface driver descriptor structure
...
#define D4D_MCU_BUS_CLOCK 24000000  /* Mcu bus clock in Hz mainly for few delay loops in low level*/
