...
breathe_projects = { "BrewPi Firmware": '_build/doxygen/xml'}
...
doxy_tag_file = os.path.abspath('_build/doxygen/doxylink.tag')
doxy_html_dir = os.path.abspath('_build/html/doxygen')
