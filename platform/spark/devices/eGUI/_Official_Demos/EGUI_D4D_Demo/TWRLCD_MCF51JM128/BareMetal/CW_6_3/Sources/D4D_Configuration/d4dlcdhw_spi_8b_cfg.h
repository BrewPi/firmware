...
//#define D4DLCD_DISPLAY_MCU_USER_INIT;
  ...
  * Signals definition
  *******************************************/
  #define D4DLCD_CS              3         // CS   
  #define D4DLCD_CS_PORT         PTBD      // CS 
  #define D4DLCD_CS_DDR          PTBDD     // CS    

  #define D4DLCD_DC              4         // DC 
  #define D4DLCD_DC_PORT         PTFD      // DC 
  #define D4DLCD_DC_DDR          PTFDD     // DC
  
  #define D4DLCD_RESET           5         // RESET     
  ...
  #define D4DLCD_ASSERT_CS      RESET(D4DLCD_CS); asm(nop);
  #define D4DLCD_DEASSERT_CS    asm(nop); asm(nop); asm(nop); asm(nop); SET(D4DLCD_CS);
