...
// the string d4dtch_gpio8080_byte_8b_ID must be replaced by define created one line up
  ...
  #include "low_level_drivers/LCD/lcd_hw_interface/gpio_8080_byte_8bit/d4dlcdhw_gpio8080_byte_8b.h"
  /******************************************************************************
  * Macros
  ******************************************************************************/
  #if D4D_COLOR_SYSTEM != D4D_COLOR_SYSTEM_RGB565
    #error The eGUI low level driver "d4dlcdhw_gpio8080_byte_8b" not supported selected type of D4D_COLOR_SYSTEM. To run this driver just select D4D_COLOR_SYSTEM_RGB565.
  #endif
  /******************************************************************************
  ...
  ******************************************************************************/
  ...
  static void D4DLCDHW_SendDataWord_Gpio8080Byte_8b(unsigned short value);
  static void D4DLCDHW_SendCmdWord_Gpio8080Byte_8b(unsigned short cmd);
  ...
  static void D4DLCD_FlushBuffer_Gpio8080Byte_8b(D4DLCD_FLUSH_MODE mode);
