...
#include "pinmap_hal.h"
  #define D4DLCD_INIT_CS pinMode(D4DLCD_CS, OUTPUT)
  #define D4DLCD_DEASSERT_CS HAL_Pin_Map()[D4DLCD_CS].gpio_peripheral->BSRRH = HAL_Pin_Map()[D4DLCD_CS].gpio_pin;
  #define D4DLCD_ASSERT_CS HAL_Pin_Map()[D4DLCD_CS].gpio_peripheral->BSRRL = HAL_Pin_Map()[D4DLCD_CS].gpio_pin;
  #define D4DLCD_INIT_DC pinMode(D4DLCD_DC, OUTPUT)
  #define D4DLCD_DEASSERT_DC HAL_Pin_Map()[D4DLCD_DC].gpio_peripheral->BSRRH = HAL_Pin_Map()[D4DLCD_DC].gpio_pin;
  #define D4DLCD_ASSERT_DC HAL_Pin_Map()[D4DLCD_DC].gpio_peripheral->BSRRL = HAL_Pin_Map()[D4DLCD_DC].gpio_pin;
#else
