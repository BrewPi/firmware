...
typedef struct D4D_OBJECT_S {
    ...
    const D4D_OBJECT_SYS_FUNCTION* pObjFunc; ///< The pointer on object system functions.
...
******************************************************************************/
D4D_BOOL
D4D_ObjectCheckCoordinates(D4D_OBJECT* pThis, D4D_POINT point);
D4D_BOOL
D4D_IsEnabled(D4D_OBJECT* pObject);
D4D_BOOL
D4D_IsVisible(D4D_OBJECT* pObject);
D4D_BOOL
D4D_IsMineFocus(D4D_OBJECT* pObject);
void
D4D_EnableTabStop(D4D_OBJECT_PTR pObj, D4D_BOOL bEnable);
void
D4D_EnableObject(D4D_OBJECT_PTR pObj, D4D_BOOL bEnable);
void
D4D_EnableTouchScreen(D4D_OBJECT_PTR pObj, D4D_BOOL bEnable, D4D_BOOL bFastTouch);
void
D4D_ShowObject(D4D_OBJECT_PTR pObject, D4D_BOOL bShow);
void
D4D_EnableTimeTicks(D4D_OBJECT_PTR pObj, D4D_BOOL bEnable);
void
D4D_InvalidateObject(D4D_OBJECT_PTR pObject, D4D_BOOL bComplete);
void*
D4D_GetUserPointer(D4D_OBJECT* pThis);
void
D4D_CaptureKeys(D4D_OBJECT_PTR pObj);
D4D_OBJECT*
D4D_GetCapturedObject(void);
D4D_SIZE
D4D_GetClientScreenSize(D4D_OBJECT* pObject);
