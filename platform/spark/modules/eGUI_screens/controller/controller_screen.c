...
D4D_DECLARE_COLOR_LABEL(scrController_lbl_tempunit, tempFormat, COL1_X, ROW2_Y, COL1_CX, ROW2_CY, FONT_SMALL, D4D_CONST, D4D_COLOR_BLACK, LABEL_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_lbl_setpoint, "Set", COL1_X, ROW3_Y, COL1_CX, ROW3_CY, FONT_SMALL, D4D_CONST, D4D_COLOR_BLACK, LABEL_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_lbl_mode, "Mode", COL1_X, ROW5_Y, COL1_CX, ROW5_CY, FONT_SMALL, D4D_CONST, D4D_COLOR_BLACK, LABEL_COLOR);
...
D4D_DECLARE_COLOR_LABEL(scrController_beertemp, controller_beertemp, COL2_X, ROW2_Y, COL2_CX, ROW2_CY, FONT_NUMBER_LARGE, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_beersv, controller_beerset, COL2_X, ROW3_Y, COL2_CX, ROW3_CY, FONT_NUMBER_MEDIUM, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);

char beer_text[] = "Beer";
char fridge_text[] = "Fridge";
char room_text[] = "Room";
D4D_DECLARE_COLOR_LABEL(scrController_beer, beer_text, COL2_X, ROW4_Y, COL2_CX, ROW4_CY, FONT_SMALL, D4D_CONST, INITIAL_BLOCK_COLOR, BEER_FG_COLOR);

D4D_DECLARE_COLOR_LABEL(scrController_fridgetemp, controller_fridgetemp, COL3_X, ROW2_Y, COL3_CX, ROW2_CY, FONT_NUMBER_LARGE, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_fridgesv, controller_fridgeset, COL3_X, ROW3_Y, COL3_CX, ROW3_CY, FONT_NUMBER_MEDIUM, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_fridge, fridge_text, COL3_X, ROW4_Y, COL3_CX, ROW4_CY, FONT_SMALL, D4D_CONST, INITIAL_BLOCK_COLOR, FRIDGE_FG_COLOR);

D4D_DECLARE_COLOR_LABEL(scrController_roomtemp, controller_roomtemp, COL4_X, ROW2_Y, COL4_CX, ROW2_CY, FONT_NUMBER_LARGE, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_roomsv, controller_roomset, COL4_X, ROW3_Y, COL4_CX, ROW3_CY, FONT_NUMBER_MEDIUM, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_room, room_text, COL4_X, ROW4_Y, COL4_CX, ROW4_CY, FONT_SMALL, D4D_CONST, INITIAL_BLOCK_COLOR, ROOM_FG_COLOR);

D4D_DECLARE_COLOR_LABEL(scrController_mode, controller_mode, COL2_X, ROW5_Y, COL2_CX, ROW5_CY, FONT_REGULAR, D4D_NO_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_state, controller_state, COL3_X, ROW5_Y, COL3_CX+(COL3_GAP>>1), ROW5_CY, FONT_REGULAR, D4D_NO_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_time, controller_time, COL4_X-(COL3_GAP>>1), ROW5_Y, COL4_CX+(COL3_GAP>>1), ROW5_CY, FONT_REGULAR, D4D_NO_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
