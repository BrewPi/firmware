...
#define SMALL_FONT FONT_ARIAL7
#define REGULAR_FONT FONT_SEGOEUI11
#define LARGE_FONT FONT_SEGOEUI9_BIG
...
D4D_DECLARE_COLOR_LABEL(scrController_lbl_tempunit, "°C", COL1_X, ROW2_Y, COL1_CX, ROW2_CY, REGULAR_FONT, D4D_CONST, D4D_COLOR_BLACK, LABEL_COLOR);
...
// main content
D4D_DECLARE_COLOR_LABEL(scrController_name, "MUSKY OLD HORSE BLANKET", COL2_X, ROW1_Y, COL5_X-COL4_GAP-COL2_X, ROW1_CY, REGULAR_FONT, D4D_CONST, NAME_BG_COLOR, REGULAR_TEXT_COLOR);
