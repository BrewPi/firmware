...
#define INITIAL_BLOCK_COLOR D4D_COLOR_RGB(48,48,48)
...
D4D_DECLARE_COLOR_LABEL(scrController_beertemp, controller_beertemp, COL2_X, ROW2_Y, COL2_CX, ROW2_CY, LARGE_FONT, D4D_CONST, INITIAL_BLOCK_COLOR, SECONDARY_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_beersv, controller_beerset, COL2_X, ROW3_Y, COL2_CX, ROW3_CY, LARGE_FONT, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
...
D4D_DECLARE_COLOR_LABEL(scrController_fridgetemp, controller_fridgetemp, COL3_X, ROW2_Y, COL3_CX, ROW2_CY, LARGE_FONT, D4D_CONST, INITIAL_BLOCK_COLOR, SECONDARY_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_fridgesv, controller_fridgeset, COL3_X, ROW3_Y, COL3_CX, ROW3_CY, LARGE_FONT, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
...
D4D_DECLARE_COLOR_LABEL(scrController_roomtemp, controller_roomtemp, COL4_X, ROW2_Y, COL4_CX, ROW2_CY, LARGE_FONT, D4D_CONST, INITIAL_BLOCK_COLOR, SECONDARY_TEXT_COLOR);
D4D_DECLARE_COLOR_LABEL(scrController_roomsv, controller_roomset, COL4_X, ROW3_Y, COL4_CX, ROW3_CY, LARGE_FONT, D4D_CONST, INITIAL_BLOCK_COLOR, REGULAR_TEXT_COLOR);
