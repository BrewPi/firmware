...
#define D4D_DECLARE_CDV(type, name, x, y, cx, cy, font_value, font_connection, c1, c2) \
    ...
    _D4D_DECLARE_BUTTON(D4D_CONST, name, NULL, x, y, cx, cy, 0, NULL, name##_btn_relations, D4D_BTN_F_DEFAULT, NULL, NULL, AS_D4D_COLOR_SCHEME(c1), FONT_ARIAL7, NULL, NULL, NULL);
