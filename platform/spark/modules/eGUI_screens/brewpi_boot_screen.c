...
D4D_DECLARE_PICTURE(scrTest_bmpLogo, 0, 0, 90, 60, &bmp_brewpi_logo_black_90_60, D4D_OBJECT_F_ENABLED|D4D_OBJECT_F_VISIBLE, NULL, NULL);

#define TEST_TEXT_X  108
#define TEST_TEXT_CY  12
D4D_DECLARE_STD_LABEL(scrTest_title, "Brewpi Hardware Test App.", TEST_TEXT_X, 0, 320-TEST_TEXT_X, TEST_TEXT_CY, FONT_ARIAL7);
D4D_DECLARE_STD_LABEL(scrTest_text0, "", TEST_TEXT_X, TEST_TEXT_CY, 320-TEST_TEXT_X, TEST_TEXT_CY, FONT_ARIAL7);
D4D_DECLARE_STD_LABEL(scrTest_text1, "Once your hardware is tested, please go to ", TEST_TEXT_X, TEST_TEXT_CY*2, 320-TEST_TEXT_X, TEST_TEXT_CY, FONT_ARIAL7);
D4D_DECLARE_STD_LABEL(scrTest_text2, "http://brewpi.com/spark-getting-started", TEST_TEXT_X, TEST_TEXT_CY*3, 320-TEST_TEXT_X, TEST_TEXT_CY, FONT_ARIAL7);
D4D_DECLARE_STD_LABEL(scrTest_text3, "for upgrade instructions", TEST_TEXT_X, TEST_TEXT_CY*4, 320-TEST_TEXT_X, TEST_TEXT_CY, FONT_ARIAL7);
...
D4D_DECLARE_STD_SCREEN_BEGIN(screen_boot, ScreenBoot_)
    ...
    D4D_DECLARE_SCREEN_OBJECT(scrTest_text3)
